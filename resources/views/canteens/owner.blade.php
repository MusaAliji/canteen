                ...
                <div class="table-responsive">
                    ...
                    <table id="mytable" class="table table-bordred table-striped">
                        ...
                        <tr>
                            ...
                            <td><td><p data-placement="top" data-toggle="tooltip"><a href="{{action('CanteenController@show',$canteen->id)}}"><button class="btn btn-primary btn-xs" data-title="Go to products" data-toggle="modal" data-target="#go_to_products" ><span class="glyphicon glyphicon-arrow-right"></span></button></a></p></td></td>
                        </tr>
                        @endforeach
                        </tbody>
